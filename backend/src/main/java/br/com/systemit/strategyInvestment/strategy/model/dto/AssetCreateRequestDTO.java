...
public record AssetCreateRequestDTO(
                ...
                @NotBlank(message = "Required field") @Size(min = 1, max = 10, message = "Size field out range") String ticket,

                @Size(max = 250, message = "Size field out range") String description,
